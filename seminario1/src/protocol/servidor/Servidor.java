            ...
            try {
                ...
                switch (me.getPrimitiva()) {
                    ...
                    case PULL_WAIT: // a consecuencia de 1 solo hilo ...
                        ...
                        Runnable respuesta = () -> {
                            byte[] bytesIn2  = new byte[MAXDATAGRAMA];          // ojito aqui!
                            UDPHelper serialHandler2 = new UDPHelper(bytesIn2); // esta tambien
                            String mensaje_;
                            try {
                                ...
                                byte[] out = serialHandler2.aBytes(ms_);        // finalmente esta.
                                socket.send(
