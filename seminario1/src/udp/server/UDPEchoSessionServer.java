...
public class UDPEchoSessionServer {
    ...
    static final java.util.HashMap<java.net.SocketAddress,protocol.common.Sesion>
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                sock.receive(pack);
                protocol.common.Sesion s;
                if ((s = sesiones.get(pack.getSocketAddress())) == null) {
                    s = new protocol.common.Sesion(pack.getSocketAddress());
